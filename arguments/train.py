...
parser.add_argument('-optim', '--optimizer', nargs='+', default="Adam", choices=["Adam", "SGD"])
...
parser.add_argument("-lcB", "--lambda_consistencyB", help='', type=float, default=10000.0)
parser.add_argument("-lpopB", "--lambda_popB", help='', type=float, default=100.0)
