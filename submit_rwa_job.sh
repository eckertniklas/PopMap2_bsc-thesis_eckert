...
python run_train.py -S2 -NIR -S1 -treg rwa -tregtrain rwa --seed 1600 -occmodel -wd 0.0000100 -senbuilds -pret --biasinit 0.9407 --save-dir /cluster/work/igp_psr/neckert/results --builtuploss --buildinginput --segmentationinput --lambda_builtuploss 1000.0 --twoheadmethod
