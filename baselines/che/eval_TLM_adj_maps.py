...
def evaluate_meta_maps(map_path, template_path, wpop_raster_template):
    ...
    if not os.path.exists(hr_map_path) or force_recompute:
        ...
        x_stretch = 9.276624195666308
        y_stretch = 9.276624195666308
    ...
    hr_pop_map_adj[hr_pop_map_adj != hr_pop_map_adj] = 0
    hr_pop_map_adj[hr_pop_map_adj < 0] = 0
...
if __name__=="__main__":
    """
    Evaluates the TLM disagreggation on the test set of Switzerland
    """
    map_path = "/scratch2/metzgern/HAC/data/PopMapData/raw/SwissBuildings/CHE_Buildings_2020_preprocessed.tif"
