...
python run_train.py -S2 -NIR -S1 -treg rwa -tregtrain rwa --seed 1602 -occmodel -wd 0.0000001 -senbuilds -pret --biasinit 0.9407 --save-dir /cluster/work/igp_psr/neckert/results --builtuploss --buildinginput --segmentationinput --lambda_builtuploss 0.4 --twoheadmethod

# python run_train.py -S2 -NIR -S1 -treg rwa -tregtrain rwa --seed 1604 -occmodel -wd 0.0000001 -senbuilds -pret --biasinit 0.9407 --save-dir /cluster/work/igp_psr/neckert/results --builtuploss --buildinginput --segmentationinput --lambda_builtuploss 0.5 --basicmethod
