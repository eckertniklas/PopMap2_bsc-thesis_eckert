...
parser.add_argument('-smo', '--supmode', type=str, help="'unsup', 'weaksup'", default="weaksup", choices=["unsup", "weaksup"])
...
parser.add_argument('-agn', '--addgaussiannoise', action='store_true', help='')
