...
# print("Sentinel 2 config:")
# for key, value in configS2.items():
#     print(f"{key} = '{value}'")


# print("Sentinel 1 descending config:")
# for key, value in configS1desc.items():
#     print(f"{key} = '{value}'")


# print("Sentinel 1 ascending config:")
# for key, value in configS1asc.items():
#     print(f"{key} = '{value}'")
...
def download(minx, miny, maxx, maxy, name):
    ...
    if S1:
        ...
        # descending
        # for season in configS1desc.keys():
        #     start_date, finish_date = configS1desc[season]
        #     export_S1_tile(season, (start_date, finish_date), f"S1desc_{season}_" + name, exportarea, name,
        #                    url_mode=False, orbit='DESCENDING')
